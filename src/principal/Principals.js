...
function Principals (props) {
  ...
  useEffect(() => {
    PushNotification.localNotification({
      ...
      message: 'ici le message', // (required)
  ...
  const runSong = () => {
    let stop = null
    console.log('runSong..', SoundPlayer)
    if (vibreur) {
      // Vibration.vibrate(10000 * dureeVibreurAlert, true)
      Vibration.vibrate([0, 400, 800, 600, 800, 800, 800, 1000], true)
      stop = Vibration
    } else {
      if (songUrl) {
        try {
